        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                    Latest News from the Laravel Community
                </h2>
                <p class="mt-6 text-lg leading-8 text-gray-300">
                    A source of news that has been aggregated from across the internet of the Laravel Community.
                </p>
            </div>
...
const stats = [
    { name: 'Registered Sources', value: props.sources },
    { name: 'Items Aggregated', value: props.items},
]
</script>
